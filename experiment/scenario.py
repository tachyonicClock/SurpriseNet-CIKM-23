...
def scenario(
    ...
    if dataset == "MNIST":
        ...
        train_set = CORe50Dataset(root=dataset_root, train=True, transform=train_transform, mini=core_mini)
        test_set  = CORe50Dataset(root=dataset_root, train=False, transform=eval_transform, mini=core_mini)
