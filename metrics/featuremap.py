...
class FeatureMap(PluginMetric):
    ...
    def after_eval_forward(self, strategy: BaseStrategy):
        ...
        for f_map, y_class in zip(strategy.model.forward_to_featuremap(strategy.mb_x), strategy.mb_y):
            y_class = int(y_class)
    ...
    def after_eval(self, strategy: 'BaseStrategy'):
        ...
        for y, f_map in self.feature_map_sums.items():
            ...
            metrics.append(MetricValue(self, metric_name, fig2img(plt), x_plot=float(y)))
