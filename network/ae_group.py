...
class D_AE(nn.Module, IsGenerative):
    ...
    def __init__(self, latent_dims: int, output_layer_size: int, encoder=MLP_Encoder, decoder=MLP_Decoder, head=MLP_AE_Head) -> None:
        super().__init__()
    ...
    def forward(self, x: Tensor) -> typing.Tuple[Tensor, Tensor]:
        ...
        Returns:
            typing.Tuple[Tensor, Tensor]: Reconstruction and predicted class labels
        """
...
class AEGroup(nn.Module, IsGenerative, TaskAware):
    ...
    def __init__(self, make_auto_encoder: typing.Callable[[], nn.Module]) -> None:
