...
class MlpArchitectureSearch(SurpriseNetExperimenter):
    def problem_statement(self) -> vz.ProblemStatement:
        ...
        search.add_int_param("network_cfg.width", 8, 512)
        search.add_int_param("network_cfg.layer_count", 1, 5)
        search.add_discrete_param("layer_growth", [1.0, 2.0, 1.5])
        search.add_float_param("learning_rate", 1e-6, 0.001)
        search.add_float_param("prune_proportion", 0.5, 0.8)
